...
/*
 * This application is a doubly linked-list that will add, remove, insert, 
 * print head to tail and print tail to head from a doubly linked list. 
 *
